...
@Route(value = "/showResultsCopy", layout = AppNavBarLayout.class)
public class ShowResultCopy extends VerticalLayout implements HasUrlParameter<String>
{
    ...
    public ShowResultCopy(ShowResultService showResultService) 
    {
